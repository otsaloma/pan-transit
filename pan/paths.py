...
CACHE_HOME_DIR = os.path.join(XDG_CACHE_HOME, "harbour-pan-transit")
CONFIG_HOME_DIR = os.path.join(XDG_CONFIG_HOME, "harbour-pan-transit")
DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
DATA_HOME_DIR = os.path.join(XDG_DATA_HOME, "harbour-pan-transit")
LOCALE_DIR = "/usr/share/harbour-pan-transit/locale"
